...
<div id="contenido" class="p-4 flex flex-col gap-8">
    ...
    <div class="grid grid-cols-4 gap-6">
        <div v-for="p in resultados" :key="p.id" class="bg-white rounded-lg shadow p-2">
            <img :src="p.imagen" class="w-full h-64 object-cover rounded">
            <h3 class="mt-2 font-semibold text-black">@{{ p.titulo }}</h3>
        </div>
    </div>
